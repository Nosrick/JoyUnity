...
{
    public class FOVPermissive : AbstractFOVHandler
    {
        ...
        public override IFOVBoard Do(Entity viewer, WorldInstance world, Vector2Int origin, RectInt dimensions, Vector2Int[] walls)
        {
            ...
            if (m_Board.Width - origin.x - 1 < m_SightMod)
            {
            ...
            if (m_Board.Height - origin.y - 1 < m_SightMod)
            {
