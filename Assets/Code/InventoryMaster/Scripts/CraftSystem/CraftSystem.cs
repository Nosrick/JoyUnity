...
namespace InventoryMaster.Scripts.CraftSystem
{
    public class CraftSystem : MonoBehaviour
    {
        ...
        public List<Item.Item> itemInCraftSystem = new List<Item.Item>();
        public List<GameObject> itemInCraftSystemGameObject = new List<GameObject>();
        BlueprintDatabase blueprintDatabase;
        public List<Item.Item> possibleItems = new List<Item.Item>();
        ...
        public void backToInventory()
        {
            ...
            {
                GameObject.FindGameObjectWithTag("Player").GetComponent<PlayerInventory>().inventory.GetComponent<Inventory.Inventory>().addItemToInventory(itemInCraftSystem[i].itemID, itemInCraftSystem[i].itemValue);
        ...
        public void deleteItems(Item.Item item)
        {
