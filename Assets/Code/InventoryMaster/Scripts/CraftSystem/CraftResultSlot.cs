...
namespace InventoryMaster.Scripts.CraftSystem
{
    public class CraftResultSlot : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            itemGameObject.transform.GetChild(1).GetComponent<RectTransform>().localPosition = new Vector2(GameObject.FindGameObjectWithTag("MainInventory").GetComponent<Inventory.Inventory>().positionNumberX, GameObject.FindGameObjectWithTag("MainInventory").GetComponent<Inventory.Inventory>().positionNumberY);
