...
using InventoryMaster.Scripts.Item;
using UnityEditor;
using UnityEngine;
...
namespace InventoryMaster.Scripts.Inventory
{
    public class Inventory : MonoBehaviour
    {
        ...
        [SerializeField]
        public List<Item.Item> ItemsInInventory = new List<Item.Item>();
        [SerializeField]
        public int height;
        [SerializeField]
        public int width;
        ...
        public delegate void ItemDelegate(Item.Item item);
        ...
        void Start()
        {
            if (transform.GetComponent<Hotbar.Hotbar>() == null)
        ...
        public void ConsumeItem(Item.Item item)
        {
            if (ItemConsumed != null)
                ItemConsumed(item);
        }

        public void EquiptItem(Item.Item item)
        {
            if (ItemEquip != null)
                ItemEquip(item);
        }

        public void UnEquipItem1(Item.Item item)
        {
            if (UnEquipItem != null)
                UnEquipItem(item);
        }
        ...
        {
            if (GetComponent<EquipmentSystem>() == null && GetComponent<Hotbar.Hotbar>() == null && GetComponent<CraftSystem.CraftSystem>() == null)
            {
                height = 5;
                width = 5;
            ...
            else if (GetComponent<Hotbar.Hotbar>() != null)
            {
                height = 1;
                width = 9;
            ...
            else if (GetComponent<CraftSystem.CraftSystem>() != null)
            {
                height = 3;
                width = 3;
                slotSize = 55;
        ...
        public void updateSlotAmount(int width, int height)
        {
            ...
            List<Item.Item> itemsToMove = new List<Item.Item>();
            ...
            {
                foreach (Item.Item i in itemsToMove)
                {
        ...
        public List<Item.Item> getItemList()
        {
            List<Item.Item> theList = new List<Item.Item>();
            for (int i = 0; i < SlotContainer.transform.childCount; i++)
            {
                if (SlotContainer.transform.GetChild(i).childCount != 0)
        ...
        public GameObject getItemGameObjectByName(Item.Item item)
        {
            for (int k = 0; k < SlotContainer.transform.childCount; k++)
            {
                if (SlotContainer.transform.GetChild(k).childCount != 0)
                {
                    ...
                    Item.Item itemObject = itemGameObject.GetComponent<ItemOnObject>().item;
        ...
        public GameObject getItemGameObject(Item.Item item)
        {
            for (int k = 0; k < SlotContainer.transform.childCount; k++)
            {
                if (SlotContainer.transform.GetChild(k).childCount != 0)
        ...
        public void deleteItemFromInventory(Item.Item item)
        {
            for (int i = 0; i < ItemsInInventory.Count; i++)
            {
                if (item.Equals(ItemsInInventory[i]))
        ...
        public void deleteItemFromInventoryWithGameObject(Item.Item item)
        {
            for (int i = 0; i < ItemsInInventory.Count; i++)
            {
                if (item.Equals(ItemsInInventory[i]))
        ...
        public int getPositionOfItem(Item.Item item)
        {
            for (int i = 0; i < SlotContainer.transform.childCount; i++)
            {
                if (SlotContainer.transform.GetChild(i).childCount != 0)
                {
                    Item.Item item2 = SlotContainer.transform.GetChild(i).GetChild(0).GetComponent<ItemOnObject>().item;
