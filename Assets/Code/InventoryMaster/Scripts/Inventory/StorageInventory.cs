...
namespace InventoryMaster.Scripts.Inventory
{
    public class StorageInventory : MonoBehaviour
    {
        ...
        [SerializeField]
        public List<Item.Item> storageItems = new List<Item.Item>();
        ...
        {
            Item.Item item = itemDatabase.getItemByID(id);
        ...
        void Start()
        {
            ...
            while (creatingItemsForChest < randomItemAmount)
            {
                ...
                if (raffle <= inventoryItemList.itemList[randomItemNumber].rarity)
                {
                    ...
                    Item.Item item = inventoryItemList.itemList[randomItemNumber].getCopy();
