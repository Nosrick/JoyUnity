...
namespace InventoryMaster.Scripts.Hotbar
{
    public class Hotbar : MonoBehaviour
    {
        ...
        public static void menuItemCreateInventory()       //create the inventory at start
        {
            ...
            if (GameObject.FindGameObjectWithTag("Canvas") == null)
            {
                ...
                Inventory.Inventory inv = panel.AddComponent<Inventory.Inventory>();
        ...
        {
            Inventory.Inventory inv = GetComponent<Inventory.Inventory>();
