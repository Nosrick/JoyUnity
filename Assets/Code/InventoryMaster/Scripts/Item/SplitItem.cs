...
namespace InventoryMaster.Scripts.Item
{
    ...
    {     //splitting an Item
        ...
        public Inventory.Inventory inv;                          //inventory script  
        ...
        {
            inv = transform.parent.parent.parent.GetComponent<Inventory.Inventory>();
            if (transform.parent.parent.parent.GetComponent<Hotbar.Hotbar>() == null && data.button == PointerEventData.InputButton.Left && pressingButtonToSplit && inv.stackable && (inv.ItemsInInventory.Count < (inv.height * inv.width))) //if you press leftclick and and keycode
            {
