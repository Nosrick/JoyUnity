using InventoryMaster.Scripts.CraftSystem;
...
namespace InventoryMaster.Scripts.Item
{
    public class DragItem : MonoBehaviour, IDragHandler, IPointerDownHandler, IEndDragHandler
    {
        ...
        void Start()
        {
            ...
            inventory = transform.parent.parent.parent.GetComponent<Inventory.Inventory>();
        ...
        public void createDuplication(GameObject Item)
        {
            ...
            GameObject duplication = GameObject.FindGameObjectWithTag("MainInventory").GetComponent<Inventory.Inventory>().addItemToInventory(item.itemID, item.itemValue);
            duplication.transform.parent.parent.parent.GetComponent<Inventory.Inventory>().stackableSettings();
        ...
        public void OnEndDrag(PointerEventData data)
        {
            if (data.button == PointerEventData.InputButton.Left)
            {
                ...
                if (newSlot != null)
                {
                    ...
                    if (Inventory.GetComponent<Hotbar.Hotbar>() == null && Inventory.GetComponent<EquipmentSystem>() == null && Inventory.GetComponent<CraftSystem.CraftSystem>() == null)
                    {
                            ...
                            if (newSlotChildCount != 0 && isOnSlot)
                            {
                                ...
                                if (inventory.stackable && sameItem && firstItemStack && secondItemStack)
                                {
                                    ...
                                    if (fitsIntoStack && !sameItemRerferenced)
                                    {
                                        ...
                                        if (secondItemGameObject.GetComponent<ConsumeItem>().duplication != null)
                                        {
                                            ...
                                            dup.transform.parent.parent.parent.GetComponent<Inventory.Inventory>().updateItemList();
                                        }
                                    }
                                ...
                                else
                                {
                                    ...
                                    else if (!fitsIntoStack && rest == 0)
                                    {
                                        ...
                                        {
                                            newSlot.transform.parent.parent.parent.parent.GetComponent<Inventory.Inventory>().UnEquipItem1(firstItem);
                                            oldSlot.transform.parent.parent.GetComponent<Inventory.Inventory>().EquiptItem(secondItem);
                            ...
                            else
                            {
                                ...
                                {                                
                                    ...
                                    if (newSlot.transform.parent.parent.GetComponent<EquipmentSystem>() == null && oldSlot.transform.parent.parent.GetComponent<EquipmentSystem>() != null)
                                        oldSlot.transform.parent.parent.GetComponent<Inventory.Inventory>().UnEquipItem1(firstItem);
                                }
                            }
                        }
                    }
                    ...
                    if (Inventory.GetComponent<Hotbar.Hotbar>() != null)
                    {
                        int newSlotChildCount = newSlot.transform.parent.childCount;
                        bool isOnSlot = newSlot.transform.parent.GetChild(0).tag == "ItemIcon";
                        //dragging on a slot where allready is an item on
                            ...
                            if (inventory.stackable && sameItem && firstItemStack && secondItemStack)
                            {
                                ...
                                if (fitsIntoStack && !sameItemRerferenced)
                                {
                                    ...
                                    if (secondItemGameObject.GetComponent<ConsumeItem>().duplication != null)
                                    {
                                        GameObject dup = secondItemGameObject.GetComponent<ConsumeItem>().duplication;
                                        dup.GetComponent<ItemOnObject>().item.itemValue = secondItem.itemValue;
                                        Inventory.GetComponent<Inventory.Inventory>().stackableSettings();
                                        dup.transform.parent.parent.parent.GetComponent<Inventory.Inventory>().updateItemList();
                                    }
                                }
                    ...
                    if (Inventory.GetComponent<EquipmentSystem>() != null)
                    {
                        ...
                        bool fromHot = oldSlot.transform.parent.parent.GetComponent<Hotbar.Hotbar>() != null;
                        ...
                        if (newSlotChildCount != 0 && isOnSlot)
                        {
                            ...
                            if (sameItemType && !sameItemRerferenced) //
                            {
                                ...
                                if (!temp1.Equals(temp2))
                                {
                                    ...
                                    {
                                        Inventory.GetComponent<Inventory.Inventory>().UnEquipItem1(secondItem);
                                        Inventory.GetComponent<Inventory.Inventory>().EquiptItem(firstItem);
                                    }
                                    else
                                    {
                                        Inventory.GetComponent<Inventory.Inventory>().EquiptItem(firstItem);
                    ...
                    if (Inventory.GetComponent<CraftSystem.CraftSystem>() != null)
                    {
                        CraftSystem.CraftSystem cS = Inventory.GetComponent<CraftSystem.CraftSystem>();
                        int newSlotChildCount = newSlot.transform.parent.childCount;
                ...
                else
                {
                    ...
                    if (oldSlot.transform.parent.parent.GetComponent<EquipmentSystem>() != null)
                        inventory.GetComponent<Inventory.Inventory>().UnEquipItem1(dropItem.GetComponent<PickUpItem>().item);
