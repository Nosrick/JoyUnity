...
namespace JoyLib.Code.Unity.GUI
{
    public class DerivedValueBarContainer : DerivedValueContainer
    {
        ...
        {
            this.ValueRect = this.m_ValueText.GetComponent<RectTransform>();
            this.NameRect = this.m_NameText.GetComponent<RectTransform>();
        ...
        protected void SetFillAmount()
        {
            ...
            {
                this.m_ValueText.color = this.OutlineColour;
                this.m_ValueText.outlineColor = this.TextColour;
            }
            else
            {
                this.m_ValueText.color = this.TextColour;
                this.m_ValueText.outlineColor = this.OutlineColour;
            }

            if (this.BarImage.fillAmount < this.NameMid && this.InvertWhenEmptying)
            {
                this.m_NameText.color = this.OutlineColour;
                this.m_NameText.outlineColor = this.TextColour;
            }
            else
            {
                this.m_NameText.color = this.TextColour;
                this.m_NameText.outlineColor = this.OutlineColour;
            }
        }
