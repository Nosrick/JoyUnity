...
{
    public class DisplayName : MonoBehaviour, ITriggerCameInRange, ITriggerUsedHandler, ITriggerUnUsedHandler, ITriggerWentOutOfRange, ITriggerPointerEnter, IPointerExitHandler
    {
