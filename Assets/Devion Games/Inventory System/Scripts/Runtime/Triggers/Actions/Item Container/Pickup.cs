...
{
    [Icon("Item")]
    [ComponentMenu("Item Container/Pickup Item")]
    [RequireComponent(typeof(ItemCollection))]
    public class Pickup : TriggerAction
    {
        [SerializeField]
        ...
        public override void OnStart()
        {
            ...
            this.m_ItemCollection.onChange.AddListener((UnityEngine.Events.UnityAction)delegate () {
        ...
        private void DropItem(Item item)
        {
            ...
            float x = (float)(InventoryManager.DefaultSettings.maxDropDistance * Mathf.Cos(angle * Mathf.PI / 180f)) + transform.position.x;
            float z = (float)(InventoryManager.DefaultSettings.maxDropDistance * Mathf.Sin(angle * Mathf.PI / 180f)) + transform.position.z;
